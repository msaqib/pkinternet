...
(Figure~\ref{fig:panel-source}). Attribution follows the duopoly structure: among traces where the
...
\begin{figure}[t]\centering\includegraphics[width=\columnwidth]{fig_trombone_by_isp.pdf}
  \caption{Tromboning rate per source ISP over the full week.}\label{fig:panel-source}\end{figure}
