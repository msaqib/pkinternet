...
vantages trombone at 46\% (Mianwali) versus 27\% (Karachi), and the two Cybernet vantages at 34\%
(Haripur) versus 11\% (Karachi)---customers of the same operator receive materially different
routing depending on the city they connect from. Attribution follows the duopoly structure: among traces where the
...
states, the within-pair penalty of taking the hairpin is a median of just $+0.7$\,ms but a mean of
$+14.5$\,ms, a heavily skewed distribution. Most flips are near-free equal-cost detours; the cost
...
others, within the same week. Stated as RQ3 demands: \textbf{83\% of the pairs that ever trombone
