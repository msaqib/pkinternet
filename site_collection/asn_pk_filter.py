...
INPUT_JSON  = "other/isps_res.json"  # Reads the new 350k resolved data
OUTPUT_JSON = "other/isps_asn.json"       # Saves the ASN data for the 350k run
OUTPUT_PK   = "other/isps_hosted.txt"     # Your final list of Pakistan-hosted domains!
