...
Run from pkinternet root:
    python3 other/sample_100_v2.py

Input:  other/site_candidates_cisa.csv
Output: other/pk_100_final_v2.csv
"""
...
INPUT_FILE  = "other/site_candidates_cisa.csv"
OUTPUT_FILE = "other/pk_100_final_v2.csv"
TARGET      = 100
SEED        = 42
MIN_PER_SECTOR = 2
