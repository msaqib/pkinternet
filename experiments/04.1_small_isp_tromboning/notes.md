# Experiment 4.1 — Small-ISP Path-Tromboning Census (complete block coverage)

**Author:** Rayan Atif

Scales Exp 04 (one ISP, Worldcall) to the **whole small-ISP population of Pakistan**,
with **complete block coverage**. Reuses the Exp 04 pipeline and RTT-physics detector.
